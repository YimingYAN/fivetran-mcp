...
- **Run connection tests** - Diagnose connectivity and configuration issues
...
| `run_connection_tests` | Run diagnostic tests to identify connectivity/configuration issues |
